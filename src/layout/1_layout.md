...
In iced, we don't have an inspection tool. But we have the [`Element::explain`](https://docs.rs/iced/0.14/iced/type.Element.html#method.explain) function that we can apply to any [`Element`](https://docs.rs/iced/0.14/iced/type.Element.html).
